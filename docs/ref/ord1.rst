:mod:`ordec.ord1` --- ORD1 language (deprecated)
================================================

 .. warning::

 	ORD1 is not recommended anymore. Use :doc:`ord2` instead.
...
.. autofunction:: ordec.ord1.implicit_processing.preprocess
.. autofunction:: ordec.ord1.implicit_processing.postprocess
