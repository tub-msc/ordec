...
def test_course(web):
    ...
    assert state['lessonsLocked'] == [False, False, True, True, True, True, True, True, True]
    ...
    state = course_nav_state(web)
    assert state['lessonsLocked'] == [False, False, False, True, True, True, True, True, True]
    ...
    wait_for_course_marker(web, 'solved')
    state = course_nav_state(web)
    assert state['lessonsLocked'] == [False, False, False, False, True, True, True, True, True]
